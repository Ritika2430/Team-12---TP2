            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "./Product page images/bracelets4.jpg" alt = "ring">
                    </div>
                </div>
                <div class = "product-div-right">
                <span class = "product-name">Carlisa Bracelets</span>
...
<div>
      <input type="radio" id="Pink Sapphire" name="os" />
      <label for="Pink Sapphire">Pink Sapphire</label>
</div>
<div>
